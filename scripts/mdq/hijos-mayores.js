        ...
        <div>
            ...
            <div id="typeofbooking">
                ...
                <select id="typeofbookingddl">
                    ...
                    <option value="2">Reserva multiple</option>
                </select>
            ...
            <div id="infoapplicant" style="">
                <div id="datoaddizionale_0">
                    ...
                    <div>
                        ...
                        <p><span class="field-validation-valid" data-valmsg-for="addizionaleRegEx_0"
                                data-valmsg-replace="true" style="color:red"></span></p>
                    </div><input id="DatiAddizionaliPrenotante_0___testo" name="DatiAddizionaliPrenotante[0]._testo"
                ...
                <input data-val="true" data-val-number="Il campo _Id deve essere un numero."
                    ...
                    name="DatiAddizionaliPrenotante[0]._Id" type="hidden" value="49391"><input data-val="true"
                ...
                <div id="datoaddizionale_1">
                    ...
                    <div>
                        ...
                        <p><span class="field-validation-valid" data-valmsg-for="addizionaleRegEx_1"
                                data-valmsg-replace="true" style="color:red"></span></p>
                    </div><input class="text-box single-line" data-val="true"
                        data-val-date="Il campo _data deve essere una data." id="DatiAddizionaliPrenotante_1___data"
                        name="DatiAddizionaliPrenotante[1]._data" type="date" value=""><input data-val="true"
                        data-val-required="The _Obbligatorio field is required."
                        id="DatiAddizionaliPrenotante_1___Obbligatorio"
                ...
                <input data-val="true" data-val-number="Il campo _Id deve essere un numero."
                    ...
                    name="DatiAddizionaliPrenotante[1]._Id" type="hidden" value="49392"><input data-val="true"
                    data-val-number="Il campo IDTipoDatoAddizionale deve essere un numero."
                ...
                <div id="datoaddizionale_2">
                    ...
                    <div>
                        ...
                        <p><span class="field-validation-valid" data-valmsg-for="addizionaleRegEx_2"
                                data-valmsg-replace="true" style="color:red"></span></p>
                    </div><input id="DatiAddizionaliPrenotante_2___testo" name="DatiAddizionaliPrenotante[2]._testo"
                        onchange="ControlloTesto(this)" type="text" value=""><input data-val="true"
                        data-val-required="The _Obbligatorio field is required."
                        id="DatiAddizionaliPrenotante_2___Obbligatorio"
                        name="DatiAddizionaliPrenotante[2]._Obbligatorio" type="hidden" value="True">
                ...
                <input data-val="true" data-val-number="Il campo _Id deve essere un numero."
                    ...
                    name="DatiAddizionaliPrenotante[2]._Id" type="hidden" value="49393"><input data-val="true"
                    data-val-number="Il campo IDTipoDatoAddizionale deve essere un numero."
            ...
            <div id="ifMultiple" style="display: none;">
                <div id="divCompanion_0" style="display: block;">
                    ...
                    <div id="ddlRelation_0"><select id="TypeOfRelationDDL0" data-index="0">
                            <option></option>
                            <option value="9">Concubino</option>
                            <option value="2">Conyuge</option>
                            <option value="11">Conyuge divorciado</option>
                            <option value="1">Conyuge separado</option>
                            <option value="7">Hermano/Hermana</option>
                            <option value="8">Hijo de otro conyuge</option>
                            <option value="5">Hijo/a</option>
                            <option value="12">Menor en tenencia</option>
                            <option value="10">Nieto</option>
                            <option value="6">Padre/Madre</option>
                            <option value="4">Suegro/Suegra</option>
                            <option value="3">Yerno/Nuera</option>
                        </select></div>
                </div>
...
</form><form action="https://prenotami.esteri.it/Services/Booking/1018" enctype="multipart/form-data" id="bookingForm"
    method="post">    
    <div class="container" id="div-container">
        ...
        <div>
            ...
            <div id="applicantBufferDiv" style="margin:10px 0px 30px 0px;">
                <h2>Dati Richiedente</h2>
                <p><strong>Cognome</strong></p>Lucas Hernan
                <p><strong>Nome</strong></p>Spina
                <p><strong>Data di nascita</strong></p>04/10/1995
            </div>

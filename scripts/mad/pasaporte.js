...
<form action="/Services/Booking/5659" enctype="multipart/form-data" id="bookingForm" method="post">
    ...
    <div class="container" id="div-container">
        ...
        <h1 class="heading-container" id="ServizioDescrizione">Dichiarazioni di valore</h1>
        <input id="hiddenServizioDesc" name="ServizioDescrizione" type="hidden" value="Dichiarazioni di valore">
        ...
        <input data-val="true" data-val-required="The isWaitingListEnabled field is required." id="isWaitingListEnabled"
            name="isWaitingListEnabled" type="hidden" value="True">
        ...
        <div>
            ...
            <div id="typeofbooking">
                ...
                <input data-val="true" data-val-number="Il campo IDServizioErogato deve essere un numero."
                    ...
                    name="IDServizioErogato" type="hidden" value="5659">
                ...
                <input data-val="true" data-val-number="Il campo IdTipoPrenotazione deve essere un numero."
                    ...
                    name="IdTipoPrenotazione" type="hidden" value="">
            ...
            <div id="applicantBufferDiv" style="display:none;margin:10px 0px 30px 0px;">
                ...
                <p><strong>Cognome</strong></p>Cristian
                <p><strong>Nome</strong></p>Gutierrez
                <p><strong>Data di nascita</strong></p>09/06/1974
            </div>
